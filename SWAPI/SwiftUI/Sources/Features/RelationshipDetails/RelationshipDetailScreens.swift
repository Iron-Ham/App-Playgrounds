...
private struct CharacterDetailView: View {
  ...
  var body: some View {
    RelationshipDetailContainer(
      ...
      RelationshipDetailSection(title: String(localized: "Profile"), iconName: "person.crop.circle") {
        RelationshipDetailRow(label: String(localized: "Gender"), value: genderDisplay, systemImage: "figure.arms.open")
        RelationshipDetailRow(label: String(localized: "Birth year"), value: birthYearDisplay, systemImage: "calendar")
        if let eraDescription {
          RelationshipDetailRow(label: String(localized: "Galactic era"), value: eraDescription, systemImage: "sparkles")
        }
        if let relativeYearDescription {
          RelationshipDetailRow(label: String(localized: "Relative year"), value: relativeYearDescription, systemImage: "timeline.selection")
        }
      }
      ...
      RelationshipDetailCallout(
        text: String(
          localized: "More character lore, affiliations, and equipment will arrive in future updates."
        )
      )
    }
  }
...
private struct PlanetDetailView: View {
  ...
  var body: some View {
    RelationshipDetailContainer(
      ...
      RelationshipDetailSection(title: String(localized: "Environment"), iconName: "globe.asia.australia") {
        RelationshipDetailRow(label: String(localized: "Primary climate"), value: climateSummary, systemImage: "sun.max")
        RelationshipDetailRow(label: String(localized: "Population"), value: populationSummary, systemImage: "person.3")
      }
      ...
      RelationshipDetailCallout(
        text: String(
          localized: "Future releases will chart terrains, gravity, and resident bios for each world."
        )
      )
    }
  }
  ...
  var body: some View {
    RelationshipDetailContainer(
      ...
      RelationshipDetailSection(title: String(localized: "Culture"), iconName: "leaf") {
        RelationshipDetailRow(label: String(localized: "Classification"), value: RelationshipDetailFormatter.displayOrFallback(details.classification), systemImage: "square.grid.2x2")
        RelationshipDetailRow(label: String(localized: "Language"), value: RelationshipDetailFormatter.displayOrFallback(details.language), systemImage: "character.book.closed")
      }
      ...
      RelationshipDetailCallout(
        text: String(
          localized: "Expect lifecycle traits, homeworld spotlights, and cultural highlights soon."
        )
      )
    }
  }
...
private struct StarshipDetailView: View {
  ...
  var body: some View {
    RelationshipDetailContainer(
      ...
      RelationshipDetailSection(title: String(localized: "Specifications"), iconName: "wrench.and.screwdriver") {
        RelationshipDetailRow(label: String(localized: "Model"), value: details.model, systemImage: "barcode.viewfinder")
        RelationshipDetailRow(label: String(localized: "Starship class"), value: details.starshipClass.displayName, systemImage: "airplane")
      }
      ...
      RelationshipDetailCallout(
        text: String(
          localized: "Deck layouts, crew manifests, and performance metrics are planned for upcoming drops."
        )
      )
    }
  }
...
private struct VehicleDetailView: View {
  ...
  var body: some View {
    RelationshipDetailContainer(
      ...
      RelationshipDetailSection(title: String(localized: "Specifications"), iconName: "speedometer") {
        RelationshipDetailRow(label: String(localized: "Model"), value: details.model, systemImage: "ruler")
        RelationshipDetailRow(label: String(localized: "Vehicle class"), value: details.vehicleClass.displayName, systemImage: "car")
      }
      ...
      RelationshipDetailCallout(
        text: String(
          localized: "Performance envelopes, crew complements, and manufacturer histories are on the roadmap."
        )
      )
    }
  }
