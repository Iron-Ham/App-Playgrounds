...
actor PersistenceCoordinator {
  ...
  typealias Snapshot = PersistenceService.Snapshot

  private let persistenceService: PersistenceService
  private let configurationProvider: @Sendable () async throws -> PersistenceConfiguration
  ...
  init(
    ...
    configurationProvider: @escaping @Sendable () async throws -> PersistenceConfiguration,
  ...
  func observeChanges() async throws -> AsyncStream<PersistenceService.ChangeBatch> {
