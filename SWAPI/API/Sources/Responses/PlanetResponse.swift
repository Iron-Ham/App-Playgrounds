...
extension PlanetResponse {
  ...
  public struct ClimateDescriptor: Hashable, Sendable, Codable, CustomStringConvertible {
    ...
    public static func descriptors(from rawList: String) -> [ClimateDescriptor] {
      let segments =
        rawList
        .split(separator: ",")
  ...
  public struct TerrainDescriptor: Hashable, Sendable, Codable, CustomStringConvertible {
    ...
    public static func descriptors(from rawList: String) -> [TerrainDescriptor] {
      let segments =
        rawList
        .split(separator: ",")
  ...
  public struct GravityDescriptor: Hashable, Sendable, Codable, CustomStringConvertible {
    ...
    public static func descriptors(from rawList: String) -> [GravityDescriptor] {
      let segments =
        rawList
        .split(separator: ",")
